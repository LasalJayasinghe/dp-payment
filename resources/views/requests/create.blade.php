                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="width: 400px;" readonly>
                                            ...
                                            <select class="form-control" id="category" name="category"
                                                    onchange="updateSubcategory()" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Account Name"
                                                   id="account_name" name="account_name" required readonly>
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Account Number"
                                                   id="account_number" name="account_number" required readonly>
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Bank Name"
                                                   id="bank_name" name="bank_name" required readonly>
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Branch" id="branch"
                                                   name="branch" required readonly>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="priority"
                                                       id="priorityNormal" value="normal" checked>
